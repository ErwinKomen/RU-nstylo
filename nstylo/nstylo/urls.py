...
urlpatterns = [
    ...
    url(r'^ftable/list', nstylo.stylometry.views.FreqtableListView.as_view(), name='ftable_list'),
    url(r'^ftableNew', nstylo.stylometry.apiviews.nlabdetail, name='ftableNew'),
    url(r'^ntable', nstylo.stylometry.views.NlabTableDetail.as_view(), name='ntable'),
