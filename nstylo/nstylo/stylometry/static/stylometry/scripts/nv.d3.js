...
nv.interactiveGuideline = function() {
    ...
    var margin = { left: 0, top: 0 } //Pass the chart's top and left magins. Used to calculate the mouseX/Y.
        ...
        ,   dispatch = d3.dispatch('elementMousemove', 'elementMouseout', 'elementClick', 'elementDblclick', 'elementMouseDown', 'elementMouseUp', 'elementContextMenu')
        ,   showGuideLine = true
...
//                    console.log("click in interactiveGuideline");
                ...
                // if user presses right mouse down the layer, fire elementContextMenu
                if (d3.event.type === 'contextmenu') {
//                  console.log("contextmenu in interactiveGuideline");
...
nv.models.focus = function(content) {
    ...
    var margin = {top: 10, right: 0, bottom: 30, left: 0}
        ...
        , brushExtent = null
        , duration = 250
        , dispatch = d3.dispatch('brush', 'onBrush', 'renderEnd', 'onContextMenu')
        ;
...
nv.models.lineChart = function() {
    ...
    var margin = {top: 30, right: 20, bottom: 50, left: 60}
        ...
        , defaultState = null
        , noData = null
        , dispatch = d3.dispatch('tooltipShow', 'tooltipHide', 'stateChange', 'changeState', 'renderEnd', 'contextMenu')
        , duration = 250
        ;
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            interactiveLayer.dispatch.on("elementContextMenu",function(e) {
              var singlePoint, pointIndex, pointXLocation, allData = [];
              data
                  .filter(function(series, i) {
                      series.seriesIndex = i;
...
nv.models.pie = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , donutRatio = 0.5
        , arcsRadius = []
        , dispatch = d3.dispatch('chartClick', 'elementClick', 'elementDblClick', 'elementMouseover', 'elementMouseout', 'elementMousemove', 'renderEnd', 'elementContextMenu')
        ;
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            //ADDED BY IWE
            ae.on('contextmenu', function(d, i) {
                var element = this;
                dispatch.elementContextMenu({
                    data: d.data,
                    index: i,
...
nv.models.stackedArea = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , duration = 250
        , dispatch =  d3.dispatch('areaClick', 'areaMouseover', 'areaMouseout','renderEnd', 'elementClick', 'elementMouseover', 'elementMouseout', 'elementContextMenu', 'areaContextMenu')
        ;
...
nv.models.stackedAreaChart = function() {
    ...
    var margin = {top: 30, right: 25, bottom: 50, left: 60}
        ...
        , defaultState = null
        , noData = null
        , dispatch = d3.dispatch('stateChange', 'changeState', 'renderEnd', 'contextMenu')
        , controlWidth = 250
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            interactiveLayer.dispatch.on("elementContextMenu",function(e) {
                var singlePoint, pointIndex, pointXLocation, valueSum = 0, allNullValues = true;
                data.filter(function(series, i) {
                        series.seriesIndex = i;
                        return !series.disabled;
                    })
                ...
                e.xvalue = chart.x()(singlePoint,pointIndex);
...
nv.models.sunburst = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , duration = 500
        , dispatch = d3.dispatch('chartClick', 'elementClick', 'elementDblClick', 'elementMousemove', 'elementMouseover', 'elementMouseout', 'renderEnd', 'elementContextMenu');
